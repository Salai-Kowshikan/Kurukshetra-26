...
export default function Login() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center lg:justify-end px-4 py-12 lg:pr-12 xl:pr-24 overflow-hidden"
         style={{
      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="bg-gradient-to-br from-slate-900/80 to-slate-800/60 backdrop-blur-md rounded-xl p-6 border border-slate-700/50 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Email Field */}
            <div>
              <label htmlFor="email" className="block text-orange-400 text-sm font-medium mb-2">
                Email
              </label>
            ...
            {/* Password Field */}
            <div>
              <label htmlFor="password" className="block text-orange-400 text-sm font-medium mb-2">
                Password
              </label>
              <div className="relative">
          ...
          <button
            type="button"
            className="w-full bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2.5 rounded-lg transition-all flex items-center justify-center gap-3 shadow-lg text-sm"
          >
