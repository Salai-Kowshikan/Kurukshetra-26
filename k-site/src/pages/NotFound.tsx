...
export default function NotFound() {
  return (
    ...
    >
      ...
      <motion.div
        className="z-10 w-full max-w-sm rounded-2xl border border-fuchsia-500/30 bg-black/80 p-6 shadow-[0_0_40px_rgba(168,85,247,0.15)] backdrop-blur-xl sm:p-8 text-center relative overflow-hidden"
        variants={fadeUp}
      ...
      >
        ...
        <div className="mb-8 relative z-10">
          <div className="relative inline-block">
            <h2
              data-text="404"
              className="glitch-text font-(family-name:--wallpoet) text-6xl sm:text-7xl text-cyan-400 tracking-widest drop-shadow-[0_0_25px_rgba(34,211,238,0.6)] mb-2 relative z-20"
            >
              404
            </h2>
          </div>
